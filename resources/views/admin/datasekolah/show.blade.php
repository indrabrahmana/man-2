                ...
                <div class="card mt-3">
                    <div class="card-header">
                        <div class="card-title">
                            Detail Sekolah
                            <a href="{{url('admin/datasekolah', $datasekolah->id)}}/cetak_pdf" target="_blank" class="btn btn-success float-right"> Cetak</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body" style="height: 250px; display: flex; justify-content: center">
                                        <img style="height: 100%" src="{{ url("public/$datasekolah->foto") }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
